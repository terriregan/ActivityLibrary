package org.nflc.activities.components
{
	...
	public class RadioButtonItem extends RadioButton implements ISelectableItem
	{
		...
		public function RadioButtonItem( item:IItem, activity:Activity ) 
		{
			_item = item;
			_stateWatcher = BindingUtils.bindSetter( setEnabledState, activity, "completeState" );
			setStyle( "styleName", "radioButtonItem" );
		}
